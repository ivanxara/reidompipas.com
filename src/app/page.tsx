...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="relative flex flex-col lg:flex-row min-h-[85vh] w-full bg-background overflow-hidden">
        ...
        <Wrapper className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center w-full z-10 pt-28 pb-12 lg:py-0">
          ...
          <div className="lg:col-span-7 flex flex-col gap-8 lg:pr-12">
            ...
            >
              ...
              <p className="font-inter text-secondary/70 text-lg md:text-xl font-light leading-relaxed max-w-xl">
                Onde a tradição se senta à mesa. Uma experiência gastronómica
                que celebra o melhor da cozinha portuguesa com um toque de
                realeza.
              </p>
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <Link href="/eventos">
                  <Button
                    variant="ghost"
                    className="h-14 px-8 rounded-full text-base text-secondary hover:bg-secondary/5 transition-all"
                  >
                    Próximos Eventos <ArrowRight className="ml-2 w-4 h-4" />
                  </Button>
                </Link>
              </div>
        ...
        <Wrapper>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            >
              ...
              <p className="font-inter text-secondary/80 text-lg leading-relaxed font-light">
                Com uma ementa variada e confecionada com mestria, cada prato é
                uma homenagem aos sabores autênticos de Portugal. Somos também
                reconhecidos pelas nossas{" "}
            ...
            <div className="flex flex-col items-center text-center gap-10">
              <div className="space-y-4">
                ...
                <p className="font-inter text-lg font-light text-secondary/70 max-w-xl mx-auto">
                  Desfrute da nossa cozinha no conforto da sua casa. Disponível
                  através das plataformas parceiras.
                </p>
              </div>
